...
\DeclareUnicodeCharacter{1ECD}{o}  % ọ
\DeclareUnicodeCharacter{1EB9}{e}  % ẹ
\DeclareUnicodeCharacter{1ECC}{O}  % Ọ
\DeclareUnicodeCharacter{0301}{\'}  % ́ (combining acute)
\DeclareUnicodeCharacter{0300}{\`}  % ̀ (combining grave)
